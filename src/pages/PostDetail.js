...
const PostDetail = () => {
  ...
  return (
    <Box sx={{ maxWidth: 900, mx: "auto", py: { xs: 2, md: 4 }, pb: 7 }}>
      <Box sx={{ p: { xs: 3, md: 4 }, mb: 3, borderRadius: 1, color: "common.white", background: editorialGradient, boxShadow: editorialShadow }}>
      ...
      <Card elevation={0} sx={{ borderRadius: 1, overflow: "hidden", border: "1px solid", borderColor: "divider", borderTop: "4px solid #d7a44a" }}>
